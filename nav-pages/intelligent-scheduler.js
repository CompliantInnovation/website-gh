      ...
      <div className="container">
          ...
          <div className="workflow">
            ...
            <div className="workflow-case-container">
              <div className="workflow-case">
                ...
                <img
                  src="/images/intelligent-scheduller/EMRImage.png"
                  alt="EMR Image"
                />
              </div>
              <DoubleArrow
              ...
              <div className="workflow-case">
                ...
                <img
                  src="/images/intelligent-scheduller/AssessmentOfPatient.png"
              ...
              <div className="workflow-case">
                ...
                <img
                  src="/images/intelligent-scheduller/IntelligentSchedulerImage.png"
        ...
        <style jsx>{`
          ...
          .cta .contact-btn {
            color: #fff;
            background: #0096FA;
            background-image: url("/images/intelligent-scheduller/contactInactive.svg");
          ...
          .cta .contact-btn:hover {
            background: #B1E0FF;
            background-image: url("/images/intelligent-scheduller/contactHovered.svg");
            color: #0096FA;
            background-position: 22px 50%;
            background-repeat: no-repeat;
          }
          ...
          .cta .demo-btn {
            ...
            padding-left: 60px;
            background-image: url("/images/intelligent-scheduller/demoInactive.svg");
            background-position: 22px 50%;
            background-repeat: no-repeat;
            transition: background-color .3s;
          }
          ...
          .cta .demo-btn:hover {
            color: #fff;
            background: #0096FA;
            background-image: url("/images/intelligent-scheduller/demoHovered.svg");
            background-position: 22px 50%;
            background-repeat: no-repeat;
          }
